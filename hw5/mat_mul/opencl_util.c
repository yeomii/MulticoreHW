                   ...
                   size_t size, void* host_ptr)
{
  ...
  cl_mem_flags flag;
  if (read_only != 0)
    flag = /*(use_gpu != 0) ?*/ CL_MEM_READ_ONLY /*: (CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR)*/;
  else
    flag = /*(use_gpu != 0) ?*/ CL_MEM_WRITE_ONLY /*: (CL_MEM_WRITE_ONLY | CL_MEM_USE_HOST_PTR)*/;

  cl_mem buf = clCreateBuffer(*context, flag, size, /*(use_gpu != 0 ?*/ NULL /*: host_ptr)*/, &res);
...
/*  }
  ...
  {
    clEnqueueMapBuffer(
      *queue, *mem, CL_FALSE, CL_MAP_WRITE, 0, size, 0, NULL, NULL, &res);
  }*/
...
/*  }
  ...
  {
    clEnqueueMapBuffer(
      *queue, *mem, CL_TRUE, CL_MAP_READ, 0, size, 0, NULL, NULL, &res);
